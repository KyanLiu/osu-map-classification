...
const Dropdown = () => {
  ...
  return (
    <div>
      <button className='cursor-pointer w-14 h-14 hover:scale-95 active:scale-85 duration-200 z-40 relative' onClick={() => setDropdown(!dropdown)} >
        {
          dropdown ? (
      ...
      {
        dropdown && (
          <div className='fixed top-0 left-0 right-0 bottom-0 z-30 bg-gray-200 text-black flex flex-col gap-5 justify-center items-center' >
